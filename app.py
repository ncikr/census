...
pop_old['Sexual Orientation'] = "Unknown"

# read 2021 data
pop_2021 = pd.read_excel('data\msoa_pop_by_orientation.xlsx')[['Sexual Orientation', 'Population']]
...
# census_data = pd.read_csv('data.csv', dtype=str).sort_values('Year', ascending=False)
...
chart.animate(Data.filter("record['Dataset'] == 'pop_historical' | record['Dataset'] == 'pop_2021'"))
